...
#     def _compute_available_qty(self):
#         for line in self:
#             if line.product_id and line.requisition_id.source_location_id:
#                 # Calculate available quantity in the specific source location
#                 line.available_qty = line.product_id.with_context(
#                     location=line.requisition_id.source_location_id.id
#                 ).qty_available
#             else:
#                 line.available_qty = 0.0
