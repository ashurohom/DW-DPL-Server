...
class MrpProduction(models.Model):
    ...
    #     # Determine the appropriate form view based on user group
    #     view_id = self.env.ref('dw_stock_requisition.view_dw_mrp_requisition_form_manufacturing').id
    #     if self.env.user.has_group('dw_stock_requisition.group_inventory_team'):
    #         view_id = self.env.ref('dw_stock_requisition.view_dw_mrp_requisition_form_inventory_from_manufacturing').id
